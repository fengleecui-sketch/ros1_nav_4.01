 ...
 * @LastEditTime: 2023-06-13 14:54:25
 * @LastEditors: your name
 * @Description: 
 * @FilePath: /Robot_Formation/src/robot_gmapping/include/gmapping/gmapping.h
 * 可以输入预定的版权声明、个性签名、空行等
 */
#ifndef __GMAPPING_GMAPPING_H_
#define __GMAPPING_GMAPPING_H_
...
private:
    ...
    std::string laserType;     //雷达话题使用模拟仿真的雷达还是真正的雷达
