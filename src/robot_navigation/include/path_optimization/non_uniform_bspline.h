...
private:
    ...
    Eigen::Vector2d x0_, v0_, a0_; //起点的pos, vel, acc
...
public:
    ...
    Eigen::Vector2d evaluateDeBoor(double t);
    ...
    static void BsplineParameterize(const double &ts, const vector<Eigen::Vector2d> &point_set,
                                    const vector<Eigen::Vector2d> &start_end_derivative, Eigen::MatrixXd &ctrl_pts);
