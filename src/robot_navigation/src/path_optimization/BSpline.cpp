/*
 * @Author: your name
 * @Date: 2023-08-16 10:36:43
 * @LastEditTime: 2023-08-16 13:17:11
 * @LastEditors: your name
 * @Description:
 * @FilePath: /MyFormProject/src/robot_navigation/src/path_optimization/BSpline.cpp
 ...
 */
double BSpline::baseFunction(int i, int k, double u, vector<double> node_vector)
{
  // 0次B样条（1阶B样条）
  double Bik_u;
  if (k == 1)
 ...
 * @return
 */
vector<double> BSpline::u_quasi_uniform(int n, int k)
{
 ...
 * @return
 */
vector<double> BSpline::u_piecewise_B_Spline(int n, int k)
{
