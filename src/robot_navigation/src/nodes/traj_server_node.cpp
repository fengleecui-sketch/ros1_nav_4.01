...
vector<Eigen::Vector2d> traj_cmd, traj_real;
...
void bsplineCallback(robot_communication::BsplineConstPtr msg)
{
...
void odomCallbck(const nav_msgs::Odometry &msg)
{
  ...
  traj_real.push_back(Eigen::Vector2d(odom.pose.pose.position.x,
