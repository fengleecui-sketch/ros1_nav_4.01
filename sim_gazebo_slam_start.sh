...
# 2) 启动 Gazebo + robot
gnome-terminal --title="gazebo_start" -- bash -c "source ~/Gitdesktop/ros1_nav2026/devel/setup.bash; roslaunch tri_steer_gazebo sim_gazebo_rviz.launch"
...
# done
# 5）启动地图节点
gnome-terminal -t "map_start" -- bash -lc "source ~/Gitdesktop/ros1_nav2026/devel/setup.bash; roslaunch robot_costmap map_deal.launch;exec bash"
# 6) 运动规划节点
