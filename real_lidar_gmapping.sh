...
gnome-terminal -t "carto gmapping" -- bash -c "cd /home/Cartographer/Cartographer_Locatization;source install_isolated/setup.bash;roslaunch cartographer_ros my_robot_2d_mid360.launch;exec bash"
